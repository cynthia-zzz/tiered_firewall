...
echo "[*] Building bpf/xdp_tcp_pipeline.o"
clang -O2 -g -Wall -target bpf -c bpf/xdp_tcp_pipeline.c -o bpf/xdp_tcp_pipeline.o -I/usr/include/x86_64-linux-gnu

echo "[*] Build outputs:"
ls -l bpf/xdp_tcp_bloom.o bpf/xdp_tcp_exact_v2.o bpf/xdp_tcp_pipeline.o
